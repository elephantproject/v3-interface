...
export default function AuthenticatedHeader({ account, openSettings }: { account: string; openSettings: () => void }) {
  ...
  const nativeBalance = useCurrencyBalance(account, chainId ? nativeOnChain(chainId) : undefined)
  const harmonyNativeFallback = chainId === SupportedChainId.HARMONY ? nativeBalance : undefined
  ...
  return (
    <AuthenticatedHeaderWrapper>
      ...
      <PortfolioDrawerContainer>
        ...
        ) : harmonyNativeFallback ? (
          <FadeInColumn gap="xs">
            <ThemedText.HeadlineLarge fontWeight={500} data-testid="portfolio-native-balance">
              {harmonyNativeFallback.toSignificant(6)} ONE
            </ThemedText.HeadlineLarge>
            <ThemedText.BodySecondary marginBottom="20px">Wallet balance</ThemedText.BodySecondary>
          </FadeInColumn>
        ) : (
          <Column gap="xs">
