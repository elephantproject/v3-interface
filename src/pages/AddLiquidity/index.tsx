...
import { FeeAmount, NonfungiblePositionManager } from 'elephantswapv3-sdk'
import { Currency, CurrencyAmount, Percent } from 'elephantswapv3-sdk-core'
...
function AddLiquidity() {
  ...
  const handleSetCustomRange = useCallback(() => {
    if (!fullRange || !price) return

    const displayedPrice = invertPrice ? price.invert() : price
    const currentPrice = Number(displayedPrice.toSignificant(12))
    ...
    setSearchParams(searchParams)
  }, [fullRange, invertPrice, onLeftRangeInput, onRightRangeInput, price, searchParams, setSearchParams])
