...
import Pit from "./Pit";
import ArchivedStaking, { UnlockElephant } from "./Staking";
import ElephantNftMint, {
  ElephantNftAccount,
  ElephantNftCollection,
  ElephantNftDetail,
  ElephantNftEditListing,
  ElephantNftList,
  ElephantNftOverview,
} from "./ElephantNFT";
            ...
            <Suspense fallback={<Loader />}>
              {isLoaded ? (
                <Routes>
                  ...
                  <Route path="staking" element={<ArchivedStaking />} />
                  <Route
                    path="staking/archived"
                    element={<ArchivedStaking />}
                  />
                  <Route path="unlock" element={<UnlockElephant />} />

                  <Route
                    path="nft/overview"
                    element={<ElephantNftOverview />}
                  />
                  <Route path="nft" element={<ElephantNftMint />} />
                  <Route path="nft/account" element={<ElephantNftAccount />} />
                  <Route
                    path="nft/collection/:collectionAddress"
                    element={<ElephantNftCollection />}
                  />
                  <Route
                    path="nft/listing/:listingId/edit"
                    element={<ElephantNftEditListing />}
                  />
                  <Route path="nft/:id/list" element={<ElephantNftList />} />
                  <Route path="nft/:id" element={<ElephantNftDetail />} />
