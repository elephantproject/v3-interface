...
module.exports = {
  ...
  overrides: [
    ...
    {
      // eslint-plugin-import can read its export map before Program:exit populates it when this newly added
      // route entry is linted by the development server, causing a TypeError instead of a lint result.
      files: ['src/pages/Analytics/index.tsx'],
      rules: {
        'import/no-unused-modules': 'off',
      },
    },
